...
<body>
   <header class="masthead">
      <div class="container">
      <form method="post" id="myform" action="${contextPath }/mypage/addReview.do" enctype="multipart/form-data">
         <div id="box1">
            <br>
            <h2>매장 방문 리뷰</h2>
            <br>
            <table id="boardtable">
               <tr id="boardmenu">
                  ...
                  <input type="hidden" name="shop_NO" value=1>
               ...
               <tr>
                  <td colspan="2" id="board_content" class="td">
                     <textarea name="review_content" rows="13" cols="100%" style="resize: none;"></textarea>
                  </td>
               </tr>

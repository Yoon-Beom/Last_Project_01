...
<script type="text/javascript">
	...
	function openIdChk() {
		...
		window.open("IdCheckForm.do", "chkForm",
	...
	function submitBtn() {
		...
		} else if (frm.member_yy.value == "#" || frm.member_mm.value == "#"
				|| frm.member_dd.value == "#") {
			alert("생년월일을 선택하세요.");
			frm.member_yy.focus();
		...
		} else if (frm.member_phone1.value == ""
				|| frm.member_phone2.value == ""
				|| frm.member_phone3.value == "") {
			alert("연락처를 입력하세요.");
		...
		} else if (frm.shop_phone1.value == "" || frm.shop_phone2.value == ""
				|| frm.shop_phone3.value == "") {
			alert("매장전화를 입력하세요.");

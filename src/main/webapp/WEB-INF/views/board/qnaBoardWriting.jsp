...
<body>
 ...
 <div class="container">
<form method="post" action="${contextPath}/board/addQnABoard.do"   enctype="multipart/form-data">
 <div id="menu">
 <br>
 ...
 <div id="boardhead">
   ...
   <div class="wrting">
   <input type="submit" value="올리기" onclick="location.href='/board/qnaBoard.do?board_code=2'">
   </div>
  <br>
 <table id="boardtable">
  <tr id="boardmenu">

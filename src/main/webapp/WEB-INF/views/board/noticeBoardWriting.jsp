...
<body>
 ...
 <div class="container">
<form method="post" action="${contextPath}/board/addNoticeBoard.do"   enctype="multipart/form-data">
 <div id="menu">
 <br>
 ...
 <div id="boardhead">
   ...
   <div class="wrting">
   상단 공지 : 
   <input type="radio" name="board_level" value="1" >여 &nbsp;&nbsp;
   <input type="radio" name="board_level" value="0" >부 &nbsp;&nbsp;

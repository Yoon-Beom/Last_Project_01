...
public class MemberVO {
	 ...
	 public MemberVO(String member_id, String member_pwd, String member_name, String member_birth,
			 String member_phone, String member_email, String member_gender, String member_address) {
	...
	public String getMember_heartShop() {
		return member_heartShop;
	}
	public void setMember_heartShop(String member_heartShop) {
		this.member_heartShop = member_heartShop;
	}
}
